...
(function() {
  ...
  Session = (function() {
    ...
    Session.prototype.needs_sync = function() {
      return this.session.storage.dirty.length > 0;
    };
    ...
    Session.prototype.update = function(since) {
      ...
      if (since === null) {
        since = this.storage.get("last_update") || 0;
      }
      dfd = new jq.Deferred;
      success = function(data) {
        _this.storage.set("last_update", util.unix_time());
        _this._cache_results(data.results);
